...
% task 2 module 4
% quando se pretende minimizar o consumo de energia
...
n= inf;     % mudar para um inteiro, se quisermos um nº especifico de fluxos
[sP nSP]= calculatePaths(L,T,n);

tempo= 10;
% minimizar a energia => forcar a que a solucao nao ultrapasse os 10Gb
% tem se gerar solucoes ate que nao se ultrapasse os 10Gb
...
hold on
plot(sort(allValues));
legend('Greedy Randomized','Hill Climbing', 'Location','southeast');
...
% hill para minimizar o consumo de energia, nao traz grandes ganhos
% nao consegue melhorar
