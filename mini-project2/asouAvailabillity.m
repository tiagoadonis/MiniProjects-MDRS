...
% o primeiro percurso tem que ser sempre mais disponivel que o segundo, o
% segundo percurso tem que ter disponibilidade <= que o primeiro,
% obrigatoriamente

% devolve o loads, indicando para cada ligacao e para cada sentido a carga
% necessaria
