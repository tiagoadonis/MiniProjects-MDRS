        ...
        while continuar
            ...
            for i = ax2
                ...
                for k = 1:nSP(i)                                                 % nSp(i) = numero de percursos para o fluxo i
                    ...
                    if energy < best                                                % ficar com a melhor solucao de todas 
                        k_best = k;
                        best = energy;
                    end
                end
...
for k = 1:length(n)
    ...
    while toc(t) < time                                                       % percorrer ate a condicao time ser atingida
        ...
        while continuar
            ...
            for i = ax2
                ...
                if k_best > 0
                    ...
                    continuar = true;
                    break;
                end                                            % funcao objetivo = minimizar as cargas
            end
        end 
        energy = best;
        ...
        allValues = [allValues energy];                                        % guardar todos os valores de carga maxima de todas as solucoes
        if energy < bestEnergy
            bestSol = sol;
            bestEnergy = energy;
        end
...
title({'Multi start Hill Climbing algorithm'}, {'to minimize the energy consumption of the network'});
xlabel('No. of solutions');
ylabel('Quality of solutions');  
legend('All possible routing paths','10 shortest routing paths','5 shortest routing paths','Location','southeast');
