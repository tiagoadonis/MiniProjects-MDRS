function [PL , APD , MPD , TT, APD64, APD110, APD1518] = Simulator1(lambda,C,f,P)
% INPUT PARAMETERS:
...
TRANSMITTED64BYTES = 0;      % No. of transmitted packets with 64 bytes
TRANSMITTED110BYTES = 0;     % No. of transmitted packets with 110 bytes
TRANSMITTED1518BYTES = 0;    % No. of transmitted packets with 1518 bytes

DELAY64 = 0;                % Sum of the delays of transmitted packets with 64 bytes
DELAY110 = 0;               % Sum of the delays of transmitted packets with 110 bytes
DELAY1518 = 0;              % Sum of the delays of transmitted packets with 1518 bytes
...
while TRANSMITTEDPACKETS < P               % Stopping criterium
    ...
    switch Event
        ...
        case DEPARTURE               % If first event is a DEPARTURE
            ...
            if (PacketSize == 64)
                TRANSMITTED64BYTES = TRANSMITTED64BYTES + 1;
                DELAY64 = DELAY64 + (Clock - ArrivalInstant);
            elseif (PacketSize == 110)
                TRANSMITTED110BYTES = TRANSMITTED110BYTES + 1;
                DELAY110 = DELAY110 + (Clock - ArrivalInstant);
            elseif (PacketSize == 1518)
                TRANSMITTED1518BYTES = TRANSMITTED1518BYTES + 1;
                DELAY1518 = DELAY1518 + (Clock - ArrivalInstant);
            else
...
APD64 = 1000*DELAY64/TRANSMITTED64BYTES;        % in milliseconds
APD110 = 1000*DELAY110/TRANSMITTED110BYTES;     % in milliseconds
APD1518 = 1000*DELAY1518/TRANSMITTED1518BYTES;  % in milliseconds
end
